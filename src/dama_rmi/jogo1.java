 ...
 * @author ediberto
 */
public class jogo1 extends UnicastRemoteObject implements IterfeceRemota {

    String nome ;
    String endereço = "//localhost:5555";
    loby l;

    jogo1(String nomer,String end,String port,boolean turn,String cor) throws RemoteException {
        super();
        nome=nomer;
        l= new loby(nomer,cor,turn);
        endereço="//"+end+":"+port;
        l.setVisible(true);
    }
